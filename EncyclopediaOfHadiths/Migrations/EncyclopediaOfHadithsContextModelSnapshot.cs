...
namespace EncyclopediaOfHadiths.Migrations
{
    ...
    partial class EncyclopediaOfHadithsContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EncyclopediaOfHadiths.Models.HadithsChapter", b =>
                {
                    ...
                    b.ToTable("HadithsChapters", (string)null);
                });

            modelBuilder.Entity("EncyclopediaOfHadiths.Models.HadithsHashTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HadithsHashTags", (string)null);
                });
            ...
            modelBuilder.Entity("EncyclopediaOfHadiths.Models.HadithsReview", b =>
                {
                    ...
                    b.ToTable("HadithsReviews", (string)null);
                });
            ...
            modelBuilder.Entity("EncyclopediaOfHadiths.Models.HadithType", b =>
                {
                    ...
                    b.ToTable("HadithTypes", (string)null);
                });

            modelBuilder.Entity("EncyclopediaOfHadiths.Models.HashTag", b =>
                {
                    b.Property<long>("HashTagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("HashTagId"), 1L, 1);
            ...
            modelBuilder.Entity("EncyclopediaOfHadiths.Models.NarratorLevel", b =>
                {
                    ...
                    b.ToTable("NarratorLevels", (string)null);
                });
            ...
            modelBuilder.Entity("EncyclopediaOfHadiths.Models.NarratorsChain", b =>
                {
                    ...
                    b.ToTable("NarratorsChains", (string)null);
                });
            ...
            modelBuilder.Entity("EncyclopediaOfHadiths.Models.ReviewTerm", b =>
                {
                    ...
                    b.Property<string>("ReviewTermTitle")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("ReviewTerms", (string)null);
                });
            ...
            modelBuilder.Entity("EncyclopediaOfHadiths.Models.HadithsHashTag", b =>
                {
                    b.HasOne("EncyclopediaOfHadiths.Models.Hadith", "Hadith")
                        .WithMany("HadithsHashTags")
                        .HasForeignKey("HadithId")
                        .IsRequired();

                    b.HasOne("EncyclopediaOfHadiths.Models.HashTag", "HashTag")
                        .WithMany("HadithsHashTags")
