...
namespace EncyclopediaOfHadiths.Areas.Admin.Controllers
{
    ...
    public class PartsController : Controller
    {
        ...
        public PartsController(EncyclopediaOfHadithsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PartId,PartTitle")] Part part)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PartId,PartTitle")] Part part)
        {
            if (id != part.PartId)
            {
                return NotFound();
